...
cf1,cf2 = signal.butter(4,0.1) #coeficientes do filtro
...
tentativas = np.arange(0,0.4,0.001)
#tentativas = [0.2]
n = 1
for i in tentativas:
...
###### Coeficientes Com shift ######
    ...
    #the r_squared - coeficiente de determinação 
    #valor de 0 a 100%, quanto mais alto menor a diferença entre os dados
    #ajustados e os dados observados
    r_squared = 1 - (ss_res / ss_tot)
...
arq.close()
'''
graficos residuais - residual plots
